...
local Themes = {
    Default = {
        ...
        SecondaryBackground = Color3.fromRGB(21, 21, 21),
        TertiaryBackground = Color3.fromRGB(18, 18, 18),
        QuaternaryBackground = Color3.fromRGB(24, 24, 24),
        Accent = Color3.fromRGB(153, 255, 238),
        SecondaryAccent = Color3.fromRGB(103, 172, 161),
        Text = Color3.fromRGB(255, 255, 255),
        SecondaryText = Color3.fromRGB(180, 180, 180),
        TertiaryText = Color3.fromRGB(97, 97, 97),
        WaveColor = Color3.fromRGB(181, 249, 255),
        ButtonHover = Color3.fromRGB(101, 168, 157)
    },
    Halloween = {
        Background = Color3.fromRGB(25, 20, 28),
        SecondaryBackground = Color3.fromRGB(18, 15, 20),
        TertiaryBackground = Color3.fromRGB(15, 12, 17),
        QuaternaryBackground = Color3.fromRGB(20, 17, 22),
        Accent = Color3.fromRGB(255, 140, 0),
        SecondaryAccent = Color3.fromRGB(186, 85, 35),
        Text = Color3.fromRGB(245, 235, 225),
        SecondaryText = Color3.fromRGB(180, 170, 160),
        TertiaryText = Color3.fromRGB(120, 100, 90),
        WaveColor = Color3.fromRGB(255, 165, 50),
        ButtonHover = Color3.fromRGB(204, 85, 0)
    },
    Christmas = {
        Background = Color3.fromRGB(25, 30, 28),
        SecondaryBackground = Color3.fromRGB(18, 21, 20),
        TertiaryBackground = Color3.fromRGB(15, 18, 17),
        QuaternaryBackground = Color3.fromRGB(20, 24, 22),
        Accent = Color3.fromRGB(220, 50, 47),
        SecondaryAccent = Color3.fromRGB(34, 139, 34),
        Text = Color3.fromRGB(240, 245, 240),
        SecondaryText = Color3.fromRGB(180, 185, 180),
        TertiaryText = Color3.fromRGB(100, 110, 100),
        WaveColor = Color3.fromRGB(165, 42, 42),
        ButtonHover = Color3.fromRGB(178, 34, 34)
    },
    Summer = {
        Background = Color3.fromRGB(28, 32, 35),
        SecondaryBackground = Color3.fromRGB(20, 23, 25),
        TertiaryBackground = Color3.fromRGB(17, 20, 22),
        QuaternaryBackground = Color3.fromRGB(22, 26, 28),
        Accent = Color3.fromRGB(255, 200, 87),
        SecondaryAccent = Color3.fromRGB(64, 224, 208),
        Text = Color3.fromRGB(255, 250, 240),
        SecondaryText = Color3.fromRGB(200, 195, 185),
        TertiaryText = Color3.fromRGB(120, 115, 105),
        WaveColor = Color3.fromRGB(255, 215, 100),
        ButtonHover = Color3.fromRGB(255, 165, 0)
    },
    Easter = {
        Background = Color3.fromRGB(32, 28, 35),
        SecondaryBackground = Color3.fromRGB(23, 20, 25),
        TertiaryBackground = Color3.fromRGB(20, 17, 22),
        QuaternaryBackground = Color3.fromRGB(26, 22, 28),
        Accent = Color3.fromRGB(221, 160, 221),
        SecondaryAccent = Color3.fromRGB(152, 251, 152),
        Text = Color3.fromRGB(250, 245, 250),
        SecondaryText = Color3.fromRGB(190, 185, 190),
        TertiaryText = Color3.fromRGB(110, 105, 110),
        WaveColor = Color3.fromRGB(238, 130, 238),
        ButtonHover = Color3.fromRGB(186, 85, 211)
    },
    Winter = {
        Background = Color3.fromRGB(25, 28, 32),
        SecondaryBackground = Color3.fromRGB(18, 20, 23),
        TertiaryBackground = Color3.fromRGB(15, 17, 20),
        QuaternaryBackground = Color3.fromRGB(20, 22, 26),
        Accent = Color3.fromRGB(135, 206, 235),
        SecondaryAccent = Color3.fromRGB(100, 149, 237),
        Text = Color3.fromRGB(245, 248, 255),
        SecondaryText = Color3.fromRGB(185, 195, 205),
        TertiaryText = Color3.fromRGB(105, 115, 125),
        WaveColor = Color3.fromRGB(173, 216, 230),
        ButtonHover = Color3.fromRGB(70, 130, 180)
    },
    Autumn = {
        Background = Color3.fromRGB(30, 25, 20),
        SecondaryBackground = Color3.fromRGB(21, 18, 15),
        TertiaryBackground = Color3.fromRGB(18, 15, 12),
        QuaternaryBackground = Color3.fromRGB(24, 20, 17),
        Accent = Color3.fromRGB(210, 105, 30),
        SecondaryAccent = Color3.fromRGB(184, 134, 11),
        Text = Color3.fromRGB(245, 240, 230),
        SecondaryText = Color3.fromRGB(190, 180, 170),
        TertiaryText = Color3.fromRGB(110, 100, 90),
        WaveColor = Color3.fromRGB(218, 165, 32),
        ButtonHover = Color3.fromRGB(184, 134, 11)
    },
    Valentine = {
        Background = Color3.fromRGB(32, 25, 28),
        SecondaryBackground = Color3.fromRGB(23, 18, 20),
        TertiaryBackground = Color3.fromRGB(20, 15, 17),
        QuaternaryBackground = Color3.fromRGB(26, 20, 22),
        Accent = Color3.fromRGB(255, 105, 180),
        SecondaryAccent = Color3.fromRGB(219, 112, 147),
        Text = Color3.fromRGB(255, 245, 250),
        SecondaryText = Color3.fromRGB(200, 185, 195),
        TertiaryText = Color3.fromRGB(120, 105, 115),
        WaveColor = Color3.fromRGB(255, 182, 193),
        ButtonHover = Color3.fromRGB(220, 20, 60)
    },
    Dark = {
        Background = Color3.fromRGB(15, 15, 15),
        SecondaryBackground = Color3.fromRGB(10, 10, 10),
        TertiaryBackground = Color3.fromRGB(8, 8, 8),
        QuaternaryBackground = Color3.fromRGB(12, 12, 12),
        Accent = Color3.fromRGB(150, 150, 255),
        SecondaryAccent = Color3.fromRGB(100, 100, 200),
        Text = Color3.fromRGB(220, 220, 220),
        SecondaryText = Color3.fromRGB(150, 150, 150),
        TertiaryText = Color3.fromRGB(80, 80, 80),
        WaveColor = Color3.fromRGB(100, 100, 180),
        ButtonHover = Color3.fromRGB(75, 75, 150)
    }
}
...
function Luxt1.CreateWindow(libName, logoId)
    ...
    themeBtn.Parent = sideHeading
    themeBtn.BackgroundColor3 = CurrentTheme.QuaternaryBackground
    themeBtn.Position = UDim2.new(0.0508064516, 0, 0.875, 0)
    themeBtn.Size = UDim2.new(0, 76, 0, 22)
    themeBtn.ZIndex = 2
    ...
    themeBtnCorner.CornerRadius = UDim.new(0, 5)
    themeBtnCorner.Parent = themeBtn
    
    local themeIndex = 1
    local themeList = Luxt1.GetAvailableThemes()
    ...
    themeBtn.MouseButton1Click:Connect(function()
        ...
        Luxt1.SetTheme(themeList[themeIndex])
            ...
            if v:IsA("Frame") then
                for i,v in next, v:GetChildren() do
                    ...
                    if v:IsA("ImageLabel") then
                        v.ImageColor3 = CurrentTheme.Accent
                    end
                end
            end
        end
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        function sectionHandling:Section(sectionText)
            ...
            function ItemHandling:Toggle(toggInfo, callback)
                ...
                checkBtn.MouseButton1Click:Connect(function()
                    if not togDe then
                        ...
                        callback(on) 
                        if on then
                            checkBtn.Parent.toggleInfo.TextColor3 = CurrentTheme.Accent
                            checkBtn.ImageColor3 = CurrentTheme.Accent
                            checkBtn.ImageRectOffset = Vector2.new(4, 836)
                            checkBtn.ImageRectSize = Vector2.new(48,48)
                        else
                            checkBtn.Parent.toggleInfo.TextColor3 = CurrentTheme.TertiaryText
                            checkBtn.ImageColor3 = CurrentTheme.TertiaryText
                            checkBtn.ImageRectOffset = Vector2.new(940, 784)
                            checkBtn.ImageRectSize = Vector2.new(48,48)
                        end
            ...
            function ItemHandling:KeyBind(keyInfo, first, callback)
                ...
                keybindInfo.TextColor3 = CurrentTheme.Text
